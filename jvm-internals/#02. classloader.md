...
* Prevents overriding core classes like `java.lang.String`.

Consistency:

* Ensures one class definition across application.

Hierarchy:

* Child can access parent classes.
* Parent cannot access child classes.
...
![Use_Cases_of_ClassLoader](classloader_usecase.png)
