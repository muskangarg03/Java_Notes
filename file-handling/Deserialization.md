# Java Deserialization and Data Exchange
...
![Serialization_Deserialization_process](deserialization_process.png)
...
**Compatible Changes** (can keep same serialVersionUID):
- Adding new fields with default values
- Adding or removing transient fields
- Changing field from non-transient to transient
- Adding or removing static fields
- Changing access modifiers

**Incompatible Changes** (must change serialVersionUID):
- Changing field types (int to double)
- Removing non-transient fields
