...
### Important: Interfaces Cannot Be Final

```java
sealed interface Payment permits CreditCard, PayPal {
}

// This will NOT compile - interfaces cannot be final
final class CreditCard implements Payment {
} // ERROR: Cannot use 'final' with interface implementation

// Correct approaches:
sealed class CreditCard implements Payment permits VisaCard, MasterCard {
}
