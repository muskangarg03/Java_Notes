...
Collections manage and store data, whereas streams focus on processing data.

Key differences:

* Collections store elements; streams do not
* Collections allow modification; streams perform immutable operations
* Collections use external iteration; streams use internal iteration
* Collections can be reused; streams are single-use
* Collections process eagerly; streams evaluate lazily
...
![Streams_Usage](images/stream_usage.png)
